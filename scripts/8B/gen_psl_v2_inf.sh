...
OUTPUT_DIR="output/8B/gen_psl_v2_freeze"
RUN_NAME="gen_psl_v2_freeze"
LOSS_TYPE="psl_v2"
NUM_TURN=10
LABEL_THR=0.9
...
deepspeed --master_port 29505  --include $DEEPSPEED_GPUS \
    ...
    --lora_path /workspace/pangyunhe/project/crossnd/llm/output/8B/gen_psl_v2_freeze/checkpoint-160 \
    --bf16 