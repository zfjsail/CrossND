...
# DEEPSPEED_GPUS="localhost:2,3,4,5,6,7"
# 模型和数据参数
...
OUTPUT_DIR="output/kddcup/gen_psl_v2_turn_v3"
RUN_NAME="gen_psl_v2_turn_v3"
LOSS_TYPE="psl_v2"
NUM_TURN=32
LABEL_THR=0.9
...
deepspeed --master_port 29505  --include $DEEPSPEED_GPUS \
    ...
    --resume_from_checkpoint /workspace/pangyunhe/project/crossnd/llm/output/kddcup/gen_psl_v2_turn_v3/checkpoint-300 \
