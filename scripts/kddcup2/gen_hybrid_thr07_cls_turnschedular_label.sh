...
OUTPUT_DIR="output/kddcup/hybrid_thr07_cls_turnschedular_label"
RUN_NAME="hybrid_thr07_cls_turnschedular_label"
LOSS_TYPE="ce"
NUM_TURN=10
LABEL_THR=0.7
...
deepspeed --master_port 29505  --include $DEEPSPEED_GPUS \
    train.py \
    --base_model_save_path /workspace/pangyunhe/models/Qwen/qwen3_wo_label \
