...
OUTPUT_DIR="output/ablation/gen-hard-outer-hybrid-thr07-sim05"
RUN_NAME="gen_hard_outer_hybrid_thr07_sim05"
AUTHOR_SIM=0.5
LOSS_TYPE="ce"
NUM_TURN=10
LABEL_THR=0.7
...
SAVE_STEPS=0.05
# 运行训练命令
deepspeed --master_port 29508  --include $DEEPSPEED_GPUS \
    train.py \
