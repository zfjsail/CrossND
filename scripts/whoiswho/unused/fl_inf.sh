...
OUTPUT_DIR="output/whoiswho/cls_half_fl_inf"
RUN_NAME="cls_half_fl_inf"
LOSS_TYPE="ce_fl"
NUM_TURN=10
# LoRA配置
LORA_R=16
...
deepspeed --master_port 29500  --include $DEEPSPEED_GPUS \
    inference.py \
    --lora_path /workspace/pangyunhe/project/crossnd/llm/output/whoiswho/cls_half_fl/checkpoint-1078 \
    --dataset whoiswho \
    --label_thr 0.7 \
    --hybrid_train false \
    --paper_slct_num 100 \
