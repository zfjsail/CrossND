...
DATA_SRC="/workspace/pangyunhe/project/crossnd/llm/data/whoiswho/self_clean_float_halfsubset_pout_sim.json"
...
SAVE_STEPS=0.05
# 运行训练命令
deepspeed --master_port 29550  --include $DEEPSPEED_GPUS \
    train.py \
    --dataset whoiswho \
    --label_thr 0.9 \
    --hybrid_train false \
