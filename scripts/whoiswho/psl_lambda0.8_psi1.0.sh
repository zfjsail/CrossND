...
OUTPUT_DIR="output/whoiswho/psl_lambda0.8_psi1.0"
RUN_NAME="whoiswho_psl_lambda0.8_psi1.0"
LOSS_TYPE="psl_v2"
NUM_TURN=10
PSL_LAMBDA=0.8
PSL_PSI=1.0
...
OUTPUT_DIR="output/whoiswho/psl_lambda0.8_psi1.0_hybrid"
...
do    
    ...
    deepspeed --master_port 29500  --include $DEEPSPEED_GPUS \
        inference.py \
        --lora_path "output/whoiswho/psl_lambda0.8_psi1.0/best_checkpoint" \
        --dataset whoiswho \
        --author_sim 0.5 \
        --label_thr 0.9 \
        --hybrid_train true \
