...
while true; do
    RANDOM_PORT=$((30000 + RANDOM % 30001))
...
OUTPUT_DIR="output/ablation/ce-hard-outer-hybrid-TAO"
RUN_NAME="ce_hard_outer_hybrid_TAO"
LOSS_TYPE="ce_temperature"
NUM_TURN=10
# LoRA配置
LORA_R=16
LORA_ALPHA=32
...
SAVE_STEPS=0.1
# 运行训练命令
deepspeed --master_port $RANDOM_PORT --include $DEEPSPEED_GPUS \
    train.py \
    --loss_type $LOSS_TYPE \
    --hybrid_train true \
    --paper_slct_num 100 \
